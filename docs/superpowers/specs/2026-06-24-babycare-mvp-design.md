...
- V1.1 soft deletion, edited metadata, optimistic bottle editing, owner CSV export, and family administration are implemented on `feat/v1-safe-record-editing`.
- Remaining V1.1 work: seven-day summary, PWA metadata, and network-unavailable handling. V1.2 remains a planned follow-up phase.
